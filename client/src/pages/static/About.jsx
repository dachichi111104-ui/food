...
const About = () => {
  ...
  return (
    <div>
      ...
      {/* Story timeline with scroll reveal */}
        ...
        <div className="container">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 700, margin: "0 auto" }}>
            {STORY_CARDS.map((card, i) => (
              <div key={card.year} className="scroll-reveal" style={{ display: "flex", gap: 24, alignItems: "flex-start" }}>
                {/* Icon + line */}
        ...
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 20, maxWidth: 820, margin: "0 auto" }}>
            {VALUES.map(({ Icon, title, desc }) => (
              <div key={title} className="card card-body scroll-reveal" style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                <div style={{
